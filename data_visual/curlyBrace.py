...
def curlyBrace(fig, ax, p1, p2, k_r=0.1, bool_auto=True, str_text='', int_line_num=2, fontdict={},axs_lim=[], **kwargs):
# def curlyBrace(fig, ax, p1, p2, k_r=0.1, bool_auto=True, str_text='', int_line_num=2, fontdict={}, **kwargs):
    ...
    axs_lim: list
        to keep axis limits consistent
    ...
    **kwargs : matplotlib line setting arguments
    ...
    return theta, summit, arc1, arc2, arc3, arc4# -*- coding: utf-8 -*-
